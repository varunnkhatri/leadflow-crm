...
export default async function IntegrationsPage() {
  ...
  const { data } = await supabase.from("integration_health").select("component, healthy, issue_count, checked_at").eq("business_id", profile.business_id).order("checked_at", { ascending: false });
